...
**✅ Все проблемы с белым экраном и MIME типами исправлены!**
...
- `VITE_API_URL` - URL вашего API сервиса (например, `https://amaribot-api.onrender.com`)
  - ⚠️ **Важно:** Если API на другом домене, укажите полный URL
  - Если API на том же домене, можно оставить пустым (будет использован `/api`)
